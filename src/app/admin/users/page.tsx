...
import { UserPlus, Search, CheckCircle, XCircle, Key, Edit, Trash2, Shield } from "lucide-react"
...
export default function ManageUsersPage() {
    ...
    return (
        <>
                    ...
                    <TabsContent value="system">
                        <div className="mb-6">
                            <div className="flex items-start justify-between">
                                <div>
                                    <p className="text-muted-foreground mt-1">
                                        Manage system administrators, committee members, and supervisors
                                    </p>
                                </div>
                                <Button onClick={() => handleOpenSystemUserDialog()}>
                                    <UserPlus className="h-4 w-4 mr-2" />
                                    Add System User
                                </Button>
                            </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <div className="text-2xl font-bold text-purple-600">{systemStats.admins}</div>
                                </CardContent>
                            </Card>
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <div className="text-2xl font-bold text-blue-600">{systemStats.committee}</div>
                                </CardContent>
                            </Card>
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <div className="text-2xl font-bold text-green-600">{systemStats.supervisors}</div>
                                </CardContent>
                            </Card>
                        </div>
                        ...
                        <Card>
                            <CardHeader>
                                <CardTitle>
                                    System Users ({filteredSystemUsers.length})
                                </CardTitle>
                                <CardDescription>
                                    Administrators, committee members, supervisors, and auditors
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div className="overflow-x-auto">
                                                        ...
                                                        <TableCell className="text-right">
                                                            <div className="flex items-center justify-end gap-2">
                                                                <Button
                                                                    variant="outline"
                                                                    size="sm"
                                                                    onClick={() => handleOpenSystemUserDialog(user)}
                                                                    title="Edit user"
                                                                >
                                                                ...
                                                                <Button
                                                                    variant="outline"
                                                                    size="sm"
                                                                    onClick={() => handleDeleteSystemUser(user.id, user.name || user.email)}
                                                                    title="Delete user"
            ...
            {/* System User Dialog */}
            <Dialog open={showSystemUserDialog} onOpenChange={(open) => !open && handleCloseSystemUserDialog()}>
                <DialogContent className="max-w-lg">
                    <DialogHeader>
                        <DialogTitle>
                            {editingSystemUser ? 'Edit System User' : 'Add New System User'}
                        </DialogTitle>
                        <DialogDescription>
                            {editingSystemUser
                                ? 'Update the user details below. System users cannot vote.'
                                : 'Create a new system user. System users have administrative roles and cannot vote.'}
                        </DialogDescription>
                    </DialogHeader>
                    ...
                    <div className="space-y-4 py-4">
                        ...
                        <div>
                            ...
                            <Select
                                ...
                                onValueChange={(value) => setSystemUserForm({ ...systemUserForm, role: value })}
                            >
                                <SelectTrigger>
                                    <SelectValue />
                                </SelectTrigger>
                        ...
                        <div>
                            <Label htmlFor="password">
                                Password {editingSystemUser ? '(leave blank to keep unchanged)' : '*'}
                            </Label>
                            <Input
                                id="password"
                                type="password"
                                ...
                                placeholder={editingSystemUser ? 'Leave blank to keep current password' : 'Enter password'}
                            />
                        </div>
                        ...
                        <div className="bg-muted p-3 rounded-md text-sm">
                            ...
                            <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                                <li>System users cannot participate in voting</li>
                                <li>Apartment unit will be set to "N/A"</li>
                                <li>Apartment size will be set to 0</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <DialogFooter>
                        <Button
                            type="button"
                            variant="outline"
                            onClick={handleCloseSystemUserDialog}
                            disabled={submitting}
                        >
                            Cancel
                        </Button>
                        <Button
                            type="button"
                            onClick={handleSubmitSystemUser}
                            disabled={submitting}
                        >
                            {submitting ? 'Saving...' : (editingSystemUser ? 'Update User' : 'Create User')}
                        </Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
